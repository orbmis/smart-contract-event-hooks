...
interface IPublisher {
    ...
    function fireHook(bytes32 hashedMessage, uint256 threadId, uint8 v, bytes32 r, bytes32 s) external;
    ...
    function verifyEventHook(uint256 threadId, address publisherPubKey) external view returns (bool);
